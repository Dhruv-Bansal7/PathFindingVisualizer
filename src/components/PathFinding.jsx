    ...
    render() {
        ...
        return (
            ...
            <React.Fragment>
                ...
                <div className="grid-instructions text-white">
                    <p>
                ...
                <div className="gridKey">
                    ...
                    <div className="keyItem ">
                        ...
                        <div className="keyLabel text-white">Start Node</div>
                    </div>
                    ...
                    <div className="keyItem">
                        ...
                        <div className="keyLabel text-white">End Node</div>
                    </div>
                    ...
                    <div className="keyItem">
                        ...
                        <div className="keyLabel text-white">Wall Node</div>
                    </div>
